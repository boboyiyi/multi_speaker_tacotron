...
from datasets import custom, blizzard, ljspeech
from hparams import hparams


def preprocess_custom(args):
  in_dir = os.path.join(args.base_dir, args.dataset)
  custom.build_from_path(in_dir, args.num_workers, tqdm=tqdm)
...
def main():
  ...
  parser.add_argument('--base_dir', default=os.path.expanduser('./datasets'))
  parser.add_argument('--output', default='training_f61')
